...
const BookingList: React.FC<BookingListProps> = ({
  ...
  const baseUrl = import.meta.env.VITE_API_URL || "https://admin.mobitel.in"
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="mt-6 pt-6 border-t-2 border-gray-100">
                    <div className="flex justify-end">
                      <Button
                        onClick={() => window.open(`https://admin.mobitel.in/admin/booking/customer-invoice/${booking.id}/en`, '_blank')}
